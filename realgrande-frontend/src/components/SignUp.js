  ...
  let submitHandler = (e) =>{
    ...
    const handleSignup = async () => {
        try {
            ...
            const response = await axios.post(`${process.env.REACT_APP_LINKBACKEND}/signup`,{fname,lname,email,pass,role}).catch(function(e){
    ...
    return (
        <> 
        {
        signupStatus != '' ? <h4 className='text-primary'> {signupStatus}</h4> : <></>
        }
